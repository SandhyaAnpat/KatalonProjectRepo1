...
WebUI.click(findTestObject('Object Repository/InstaTest/Page_Instagram/input_Phone number, username or email addre_701e7b'))

WebUI.setText(findTestObject('Object Repository/InstaTest/Page_Instagram/input_Phone number, username or email addre_701e7b'), 
    'sandhyasan')

WebUI.click(findTestObject('Object Repository/InstaTest/Page_Instagram/input_Phone number, username or email addre_701e7b'))

WebUI.doubleClick(findTestObject('Object Repository/InstaTest/Page_Instagram/input_Phone number, username or email addre_701e7b'))

WebUI.click(findTestObject('Object Repository/InstaTest/Page_Instagram/input_Phone number, username or email addre_701e7b'))

WebUI.doubleClick(findTestObject('Object Repository/InstaTest/Page_Instagram/input_Phone number, username or email addre_701e7b'))

WebUI.setEncryptedText(findTestObject('Object Repository/InstaTest/Page_Instagram/input_Password_password'), 'yJJvlMdMYr4koutogtOmGw==')

WebUI.click(findTestObject('Object Repository/InstaTest/Page_Instagram/div_Log in'))

WebUI.doubleClick(findTestObject('Object Repository/InstaTest/Page_Instagram/div_Log in'))
