...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/p_TestFirstname Testlastname'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_LoginUsername  AdminPassword  admin123U_4850c8'))
